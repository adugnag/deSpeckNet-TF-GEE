...
**Note: I have made some modificatons from the original implementation, such as the data is processed in dB scale and patch density is different from the original Matlab implementation.**
...
## Acknowledgment
I have used some IO functions from Google Earth Engine example workflow page. The can be found [here](https://developers.google.com/earth-engine/guides/tf_examples).

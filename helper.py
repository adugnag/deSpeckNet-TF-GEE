...
def prediction(params):
  ...
  filesList = os.system(gsutil) ls 'gs://'{params['BUCKET']}'/'{params['FOLDER']}
  ...
  jsonText = os.system(gsutil) cat {jsonFile}
  ...
  os.system(earthengine) upload image --asset_id={out_image_asset} {out_image_file} {jsonFile}
